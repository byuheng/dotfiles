  ...
  config = function()
    ...
    require('bufferline').setup {
      options = {
        ...
        left_trunc_marker = '',
        right_trunc_marker = '',
        max_name_length = 18, -- Default = 18
        max_prefix_length = 15, -- prefix used when a buffer is de-duplicated (default = 15)
        ...
        icon_pinned = '󰐃',
        minimum_padding = 1, -- Default = 1
        maximum_padding = 1, -- Default = 1
        maximum_length = 30, -- Default = 30
        sort_by = 'insert_at_end', -- New open buffer will insert at end
      },
      -- Comment this whole block if you want to use Catppuccin's default integration
      highlights = {
        -- separator = {
        --    fg = '#CDD6F4', -- Colored tab separator
        --  },
        separator_selected = { 'none' }, -- No separator between tabs
        buffer_selected = {
          bold = true,
          italic = false,
        },
        fill = {
          bg = '#1E1E2E', -- Colored top bar strip after tab(s)
        },
        -- tab_selected = {},
        -- background = {},
        -- indicator_selected = {},
